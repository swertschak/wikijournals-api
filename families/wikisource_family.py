...
__version__ = '$Id: wikisource_family.py 9442 2011-08-20 16:19:29Z xqt $'
...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'bn', 'vi', 'nl', 'tr', 'uk', 'ja', 'sr', 'el', 'ml', 'sa', 'la',
            'br', 'az', 'li', 'yi', 'mk', 'hy', 'vec', 'ca', 'is', 'ta', 'bs',
            'id', 'da', 'no', 'eo', 'et', 'sah', 'bg', 'lt', 'gl', 'kn', 'cy',
            'sk', 'zh-min-nan', 'fo',
        ]

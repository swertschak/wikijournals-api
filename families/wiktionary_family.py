...
__version__ = '$Id: wiktionary_family.py 9442 2011-08-20 16:19:29Z xqt $'
...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'ro', 'te', 'id', 'gl', 'ca', 'uk', 'cs', 'bg', 'eo', 'vo', 'is',
            'hr', 'oc', 'simple', 'scn', 'th', 'eu', 'sr', 'af', 'br', 'fy',
            'sw', 'he', 'cy', 'la', 'sq', 'sl', 'hy', 'da', 'tt', 'wa',
            'zh-min-nan', 'ka', 'az', 'lv', 'ne', 'tk', 'ast', 'ur', 'hsb',
            'kk', 'nn', 'ky', 'ps', 'wo', 'km', 'ang', 'be', 'co', 'ga', 'mr',
            'gn', 'ia', 'tl', 'sk', 'csb', 'bs', 'ms', 'st', 'nds', 'sd', 'kl',
            'sh', 'si', 'tg', 'ug', 'lb', 'ti', 'mk', 'bn', 'an', 'nah', 'gu',
